...
import com.app.viveragro.viveragro2.fragments.AvaliacoesFragment2;
import com.app.viveragro.viveragro2.fragments.AvaliacoesFragment3;
import com.app.viveragro.viveragro2.fragments.DescricaoFragment;
import com.app.viveragro.viveragro2.fragments.DescricaoFragment2;
import com.app.viveragro.viveragro2.fragments.DescricaoFragment3;
import com.app.viveragro.viveragro2.fragments.ProdutoFragment;
import com.app.viveragro.viveragro2.fragments.ProdutoFragment2;
import com.app.viveragro.viveragro2.fragments.ProdutoFragment3;


/**
 * Created by viniciusthiengo on 5/18/15.
 */
public class TabsAdapter3 extends FragmentPagerAdapter {
   ...
   // private int[] icons = new int[]{R.drawable.car_1, R.drawable.car_1, R.drawable.car_2, R.drawable.car_3, R.drawable.car_4};
    ...
    public TabsAdapter3(FragmentManager fm, Context c) {
        super(fm);
    ...
    public Fragment getItem(int position) {
        Fragment frag = null;
         if(position == 1){ // LUXURY CAR
            frag = new DescricaoFragment3();
        }
        else if(position == 0){ // SPORT CAR
            frag = new ProdutoFragment3();
        }

...
public class DescricaoFragment3 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        try{
            descStr1 = ((ProdutorConsumidorActivity) getActivity()).getDescricaoCurta();
           // descStr2 = ((ProdutorActivity) getActivity()).getDescricaoLonga();

            sitios = ((ProdutorConsumidorActivity) getActivity()).getSitio();
            phones = ((ProdutorConsumidorActivity) getActivity()).getPhone();
            enderecos = ((ProdutorConsumidorActivity) getActivity()).getEndereco();
            propriedades = ((ProdutorConsumidorActivity) getActivity()).getPropriedade();
        }catch (Exception e){

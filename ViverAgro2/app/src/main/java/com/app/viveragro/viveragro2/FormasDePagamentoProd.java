...
public class FormasDePagamentoProd extends AppCompatActivity implements ValueEventListener,Firebase.CompletionListener{
    ...
    public void pagamento(View view){
        if(escolha == 2){
            AlertDialog.Builder builder = new AlertDialog.Builder(FormasDePagamentoProd.this);

...
public class ProdutoFragment2 extends Fragment implements ValueEventListener,Firebase.CompletionListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        try{
            ...
            qtdProdutos =  ((ProdutorActivity) getActivity()).getQtdProdutos();
            id = ((ProdutorActivity)getActivity()).getId();
            produtor = ((ProdutorActivity)getActivity()).getProdutor();
            preco = ((ProdutorActivity)getActivity()).getPreco();
            consumidor = ((ProdutorActivity)getActivity()).getConsumidor();
            cont = ((ProdutorActivity)getActivity()).getCont();
        }catch (Exception e){
      ...
      //  semproduto = (RelativeLayout)view.findViewById(R.id.);
        ...
        if(qtdProdutos > 0){
            ...
            addProdutos.setVisibility(View.GONE);
            adicion.setVisibility(View.GONE);
        }
        return view;
    }
